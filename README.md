...
- `animation_create`, `animation_delete`, `animation_track_upsert`, `animation_audio_track_upsert`, `animation_track_delete`, `animation_key_upsert`, and `animation_key_delete` for scene-embedded 2D/UI property and AudioStreamPlayer2D animation.
