...
async def test_tool_catalog_exposes_read_and_write_annotations() -> None:
    ...
    assert annotations["animation_nested_track_upsert"].readOnlyHint is False
    ...
    assert annotations["tile_set_layer_set"].readOnlyHint is False
    assert annotations["tile_set_layer_remove"].destructiveHint is True
    ...
    assert annotations["tile_set_terrain_set_remove"].destructiveHint is True
    assert annotations["tile_set_terrain_remove"].destructiveHint is True
    ...
    assert annotations["tile_map_layer_terrain_paint"].readOnlyHint is False
    ...
    assert annotations["shortcut_create"].readOnlyHint is False
    assert annotations["shortcut_set"].readOnlyHint is False
    assert annotations["shortcut_save"].idempotentHint is True
    assert annotations["shortcut_undo"].readOnlyHint is False
    assert annotations["shortcut_redo"].readOnlyHint is False
