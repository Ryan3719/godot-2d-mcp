...
- 已交付：光照、遮挡、相机、视口组合、Path2D/Curve2D 的独立内嵌资源替换与 Bézier 点编辑，以及 Skeleton2D/Bone2D 的安全层级创建、Rest Pose 和撤销重做。
