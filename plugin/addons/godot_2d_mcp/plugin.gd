...
func _register_handlers() -> void:
	...
	_dispatcher.register("runtime_tween_start", runtime_handler.request_runtime_tween_start)
	_dispatcher.register("runtime_tween_result_get", runtime_handler.get_runtime_tween_result)
	_dispatcher.register("runtime_tween_stop", runtime_handler.request_runtime_tween_stop)
	...
	_dispatcher.register("node_metadata_get", node_handler.get_node_metadata)
	...
	_dispatcher.register("node_metadata_set", node_handler.set_node_metadata)
	_dispatcher.register("node_metadata_remove", node_handler.remove_node_metadata)
	...
	_dispatcher.register("resource_set_properties", resource_handler.set_resource_properties)
	_dispatcher.register("resource_save", resource_handler.save_resource)
	_dispatcher.register("resource_undo", resource_handler.undo_resource)
	_dispatcher.register("resource_redo", resource_handler.redo_resource)
	_dispatcher.register("shortcut_create", shortcut_handler.create_shortcut)
	_dispatcher.register("shortcut_set", shortcut_handler.set_shortcut)
	_dispatcher.register("shortcut_save", shortcut_handler.save_shortcut)
	_dispatcher.register("shortcut_undo", shortcut_handler.undo_shortcut)
	_dispatcher.register("shortcut_redo", shortcut_handler.redo_shortcut)
